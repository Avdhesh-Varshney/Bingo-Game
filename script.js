...
window.addEventListener('load', function () {
    ...
    // Enter button press functioning
...
function startGame(numPlayers) {
    ...
    // Targeting the background music, and audio controls buttons
    ...
    // functioning of the volume slider
    function setVolume() {
    ...
    // Creating a card for each and every player
    ...
    // Adding a event listener on the document to check whether the click is done on the numbers or something else
    ...
    // cut that number on every click and also update it into the other players cards also
    ...
    // switching the players after its click
    ...
    // Adding styling on the buttons on every click
    function addEffect() {
        const cards = document.querySelectorAll('.card');
    ...
    // On every click, checking whether is there any body who is winner
    ...
    // If winner is announced, give a congratulations to the winner
